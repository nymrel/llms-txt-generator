...
(function () {
  ...
  /* The six AI crawlers the store's own robots.txt names, plus the two search
     bots most often confused with them. Allow-listed, never blocked. */
  var AI_AGENTS = [
    ...
    ["anthropic-ai", "older Anthropic agent string"],
    ["PerplexityBot", "Perplexity's index"],
    ["Perplexity-User", "fetches a page for a Perplexity answer"],
    ["Google-Extended", "opts your pages into Gemini and AI Overviews"],
    ["Applebot-Extended", "opts your pages into Apple Intelligence"],
  ...
  function robotsTxt(platform) {
    ...
    var lines = [
      ...
      "# AI assistants and AI search crawlers are explicitly allowed.",
      "# Generated by JalenBuilds Tools · " + p.label,
      "",
      "User-agent: *",
      "Allow: /",
      "",
      "# --- AI assistant + AI search crawlers ---"
    ];
  ...
  function checklistHtml(platform) {
    ...
    var steps = [
      ...
      ["Upload <code>robots.txt</code>", "Same location. If a robots.txt already exists, merge the AI-crawler blocks into it rather than replacing the file — you may already have rules that matter."],
    ...
    var body =
      ...
      "<tr><td><code>llms.txt</code></td><td>Site root</td><td>Gives AI assistants a short, curated map of your site so they read the right pages first.</td></tr>" +
      "<tr><td><code>robots.txt</code></td><td>Site root</td><td>Names the AI crawlers explicitly and allows them. Without it you rely on the wildcard rule, which some crawlers treat conservatively.</td></tr>" +
      ...
      "<p>These files make your site easier for AI assistants to read and quote correctly. They do not guarantee that any assistant will mention you, and no one can promise that. What they remove is the technical reason for being skipped.</p>";
  ...
  function readmeTxt(platform) {
    ...
    return [
      ...
      "",
      "Everything here was generated in your browser from what you typed into the",
      "free generator. Nothing was uploaded anywhere.",
      "",
  ...
  JB.pro.register("llms-deluxe", {
    ...
    contents: [
      ...
      "robots.txt — explicit allow rules for 12 named AI crawlers, with your sitemap line",
